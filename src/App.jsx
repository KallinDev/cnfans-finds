...
function App() {
  // Wiggle Register button every 10 seconds
  useEffect(() => {
    ...
    let timer;
    function wiggle() {
      btn.style.animation = `wiggleGlow ${duration}ms cubic-bezier(.4,0,.2,1)`;
      setTimeout(() => {
        btn.style.animation = "";
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a1a2f] to-black text-[#e2e8f0]">
      ...
      <style>{`
        @keyframes wiggleGlow {
          0%, 100% { transform: rotate(0deg) scale(1); box-shadow: 0 8px 32px rgba(255,42,104,0.25); }
          7% { transform: rotate(-3deg) scale(1.03); box-shadow: 0 0 32px 6px #ff5a8a66; }
          14% { transform: rotate(3deg) scale(1.04); box-shadow: 0 0 32px 8px #ff2a6866; }
          21% { transform: rotate(-3deg) scale(1.03); box-shadow: 0 0 32px 6px #ff5a8a66; }
          28% { transform: rotate(0deg) scale(1); box-shadow: 0 8px 32px rgba(255,42,104,0.25); }
        }
